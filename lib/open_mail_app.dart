// ignore_for_file: constant_identifier_names, prefer_final_fields, prefer_interpolation_to_compose_strings
  ...
  static Future<OpenMailAppResult> composeNewEmailInMailApp({
    ...
    if (_isAndroid) {
      ...
      if (installedApps.length == 1) {
        bool result = false;
        final String? launchScheme = installedApps.first.composeLaunchScheme(emailContent);
